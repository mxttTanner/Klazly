...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    theme_color: "#0f172a",
    lang: "vi",
    // PNG sizes generated by scripts/generate-icons.mjs from icon.svg.
    // Android home-screen installs prefer the raster set; the maskable
    // variant keeps the mark inside launchers' circular/squircle crops.
    icons: [
      {
        src: "/icon-192.png",
        type: "image/png",
